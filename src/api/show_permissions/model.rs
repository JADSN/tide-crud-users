...
impl Model<DatabaseConnection, InternalMessage, MvpError> for ShowPermissions {
    fn model(
        &self,
        ...
        let retrieved_permissions = InternalMessage::retrieve_permissions(db_connection,paging)?;
        log::info!("Found [{}] permissions!", retrieved_permissions.len());
        InternalMessage::try_from(retrieved_permissions)
    }
}
